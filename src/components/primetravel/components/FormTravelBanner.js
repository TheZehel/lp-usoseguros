      ...
      <div className="container mx-auto pt-10 text-center ">
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          <div className="animate__animated animate__zoomIn rounded-lg bg-white p-10 sm:p-4 ">
            ...
            >
              <div className="w-full gap-x-8 gap-y-6 grid grid-cols-1 ">
                <div>
                  ...
                  <div className="mt-2.5">
                    <Select
                      ...
                      className="cursor-pointer focus:ring-grayUso"
                    />
                  </div>
                </div>
                    ...
                    <div className="mt-2.5">
                      <Space direction="vertical">
                        <DatePicker
                          ...
                          className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-grayUso sm:text-sm sm:leading-6"
                        />
                      </Space>
                    </div>
                  </div>
                ...
                <div className="">
                  ...
                  <input
                    type="text"
                    className="mt-2.5 block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-grayUso sm:text-sm sm:leading-6 cursor-pointer"
                    id="ages"
                    name="ages"
                    value={
                  ...
                  >
                    <div className="animate__animated animate__fadeIn bg-white rounded-lg shadow px-5 py-4 mx-auto w-96 h-96 border border-gray-300">
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center justify-around w-32">
                          <button
                            ...
                            className="bg-grayUso hover:bg-bluePrime2 text-white w-8 h-8 rounded-full flex items-center justify-center focus:outline-none"
                          >
                            -
                          </button>
                          <input
                      ...
                      <button
                        onClick={closeModal}
                        className="bg-grayUso hover:bg-bluePrime2 text-white font-bold py-2 px-4 rounded w-2/4 items-center "
                      >
                        Aplicar
                      </button>
                    </div>
            ...
            <button
              className="bg-grayUso hover:bg-bluePrime2 text-white font-bold py-2 px-4 rounded w-full flex mt-3 justify-center items-center"
              onClick={(e) => {
                handleSubmit(e);
