        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <div
                  class="flex px-4 pb-2 pt-2 sm:p-4"
                  style={{
                    padding: "0.5rem 1rem",
                ...
                <div class="flex" style={{ padding: "20px 50px" }}>
                  <div
                    style={{
                      width: "100%",
                      borderRadius: "10px",
                      boxShadow: "0 0 10px rgba(96, 134, 181, .3)",
                      textAlign: "center",
                  ...
                  >
                    ...
                    <div style={{ textAlign: "center", padding: "1rem" }}>
                      ...
                      >
                        Uma opção perfeita para quem quer garantir um ótimo
                        descanço e conforto na próxima viagem
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-5 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          <div className="lg:pr-8 lg:pt-4 flex">
            ...
            >
              ...
              >
                Ganhe um <span className="font-bold">PRESENTE ESPECIAL</span> ao
                contratar o seu Seguro viagem.
              </h1>
              <p
                className="mt-4"
