...
import SessaoInformativaProdutosLp from "../../globalsubcomponents/SessaoInformativaProdutosLp";
...
function IndexTravel() {
  ...
  return (
    <div className="IndexTravel">
      <Helmet>
        <title>Seguro Viagem | Uso Seguros Travel</title>
        <meta
          name="description"
          content="Contrate o Seguro de Viagem Uso Seguros online na Prime Secure. Parcelamento em até 12x sem juros ou pagamento via Pix para sua viagem nacional ou internacional."
        />
        <meta
          name="keywords"
        ...
        />
        <meta property="og:title" content="Seguro Viagem | Uso Seguros" />
        <meta
          property="og:description"
          content="Contrate seu Seguro de Viagem Uso Seguros Travel 100% online na Prime Secure Marketplace. Opções de parcelamento em até 12x sem juros ou pagamento via Pix. Explore coberturas amplas para sua viagem nacional ou internacional, seja ela terrestre, marítima ou aérea."
        />
